...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 11:09:05 2019
...
Original file is located at
    https://colab.research.google.com/drive/16evdz_03461o_9asVCRTvQrDswcpp9WL
"""
...
class Complex:
    ...
    def __init__(self, a=0,b=0):
      ...
      By default, the values for the attributes are 0"""
      self.a = a #real part
    ...
    def __sub__(self,other):
      """Returns a nex complex number, which is 
      the substraction of the invoking complex number and the other parameter"""
      return Complex(self.a-other.a, self.b - other.b)
    ...
    def __mul__(self,other):
      ...
      multComplex=Complex(self.a*other.a-self.b*other.b,
