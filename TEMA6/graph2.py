...
class AdjacentVertex:
    ...
    def __str__(self) -> str:
        ...
        if self.weight is not None:
            result = '(' + str(self.vertex) + ',' + str(self.weight) + ')'
        else:
...
class Graph:
    ...
    def add_edge(self, start: object, end: object, weight: int = 1) -> None:
        ...
        elif end not in self._vertices.keys():
    ...
    def contain_edge(self, start: object, end: object) -> int:
        ...
        if start not in self._vertices.keys():
            ...
            found = False
            index = 0
            while not found and index < len(self._vertices[start]):
                adj = self._vertices[start][index]
                if adj.vertex == end:
                    result = adj.weight
                    found = True
                index += 1
    ...
    def get_origins(self, vertex: object) -> list:
        ...
        if vertex not in self._vertices.keys():
            ...
            for v in self._vertices:
                found = False
                index = 0
                while not found and index < len(self._vertices[v]):
                    adj = self._vertices[v][index]
...
if __name__ == '__main__':
    ...
    print(g.contain_edge('A', 'E'))
    print(g.contain_edge('A', 'D'))
    ...
    print("g.contain_edge('B', 'C'):", g.contain_edge('B', 'C'))
    print("g.contain_edge('E', 'A'):", g.contain_edge('E', 'A'))
